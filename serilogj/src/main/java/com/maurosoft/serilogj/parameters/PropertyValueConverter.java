...
import com.maurosoft.serilogj.core.DestructuringPolicyResult;
import com.maurosoft.serilogj.core.IDestructuringPolicy;
...
import com.maurosoft.serilogj.events.DictionaryValue;
...
import com.maurosoft.serilogj.events.SequenceValue;
import com.maurosoft.serilogj.events.StructureValue;
import com.maurosoft.serilogj.parsing.Destructuring;
import com.maurosoft.serilogj.policies.BooleanScalarConversionPolicy;
import com.maurosoft.serilogj.policies.ByteArrayScalarConversionPolicy;
import com.maurosoft.serilogj.policies.EnumScalarConversionPolicy;
import com.maurosoft.serilogj.policies.SimpleScalarConversionPolicy;
import com.maurosoft.serilogj.reflection.Property;
import com.maurosoft.serilogj.reflection.Reflection;
...
public class PropertyValueConverter implements ILogEventPropertyValueFactory, ILogEventPropertyFactory {
	...
	static {
		...
		BuiltInScalarTypes.add(DateTimeZone.class);
		...
		if (Map.class.isAssignableFrom(valueType)) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
				...
				for (Map.Entry<Object,Object> entry : map.entrySet()) {
					dict.put((ScalarValue) limiter.createPropertyValue(entry.getKey(), false),
							limiter.createPropertyValue(entry.getValue(), destructuring));
				}
			}
